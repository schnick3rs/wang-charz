...
import {core} from "#server/data/archetypes/books/core.ts";
import {fspg} from "#server/data/archetypes/books/forsakenSystemPlayersGuide.ts";
import {voab} from "#server/data/archetypes/books/voab.ts";
import {sonr} from "#server/data/archetypes/books/sonsOfRuss.ts";
import {red2} from "#server/data/archetypes/books/redactedRecordsTwo.ts";
import {aioe} from "#server/data/archetypes/books/inheritanceOfEmbers.ts";
import {afas} from "#server/data/archetypes/books/afflictionAscendant.ts";
import {tnh} from "#server/data/archetypes/books/theNullHypothesis.ts";
...
const archetypeRepository: Archetype[] = ArchetypeRepositorySchema.parse(rawArchetypeRepository);
