...
const voab = [
 ...
 // RANGED WEAPONS
  ...
  {
    ...gear(source.voab.key, 67, 'Grapnel Launcher', '4U', 'IMPERIUM, ADEPTUS ASTARTES'),
 ...
 // ARMOUR
  {
    ...gear(source.voab.key,69,'Mk IV Imperial Maximus','9U','Powered,Imperium,Adeptus Astartes'),
    ...armour('Astartes Armour',5,'Powered(2)'),
    description:
  ...
  {
    ...gear(source.voab.key,69,'Mk V Heresy Armour','9U','Powered,Imperium,Adeptus Astartes'),
  ...
  {
    ...gear(source.voab.key,70,'Mk VI Corvus Armour','7V','Powered,Imperium,Adeptus Astartes'),
    ...armour('Astartes Armour',5,'Powered(2)'),
    description:
  ...
  {
    ...gear(source.voab.key,70,'Mk VII Aquila Armour','8V','Powered,Imperium,Adeptus Astartes'),
    ...armour('Astartes Armour',5,'Powered(3)'),
    description:
  ...
  {
    ...gear(source.voab.key,71,'Mk VIII Errant Armour','9U','Powered,Imperium,Adeptus Astartes'),
  ...
  {
    ...gear(source.voab.key,71,'Mk X Tacticus Armour','9V','Powered,Imperium,Adeptus Astartes,Primaris'),
    ...armour('Astartes Armour',5,'Powered(4)'),
    description:
  ...
  {
    ...gear(source.voab.key,72,'Mk X Gravis Armour','12V','Powered,Imperium,Adeptus Astartes,Primaris'),
  ...
  {
    ...gear(source.voab.key,72,'Mk X Omnis Armour','10V','Powered,Imperium,Adeptus Astartes,Primaris'),
  ...
  {
    ...gear(source.voab.key,72,'Mk X Phobos Armour','9V','Powered,Imperium,Adeptus Astartes,Primaris'),
  ...
  {
    ...gear(source.voab.key,72,'Centurion Warsuit','10U','Powered,Imperium,Adeptus Astartes'),
  ...
  {
    ...gear(source.voab.key, 73, 'Adamantine Cuirass', '8V', 'Powered,Imperium,Adeptus Astartes'),
    type: 'Armour Upgrade',
  ...
  {
    ...gear(source.voab.key, 74, 'Battle Standard', '8V', 'Imperium,Adeptus Astartes'),
    type: 'Tool',
  ...
  {
    ...gear(source.voab.key, 74, 'Halo Indomitus', '9U', 'Imperium,Adeptus Astartes'),
    type: 'Tool',
  ...
  {
    ...gear(source.voab.key, 74, 'Narthecium', '6V', 'Tool,Imperium,Adeptus Astartes,Apothecary'),
    type: 'Tool',
  ...
  {
    ...gear(source.voab.key, 75, 'Omni-Scrambler', '7V', 'Tool,Imperium,Adeptus Astartes,Infiltrator'),
    type: 'Tool',
  ...
  {
    ...gear(source.voab.key, 75, 'Sanguine Flask', '5V', 'Tool,Imperium,Adeptus Astartes'),
    type: 'Tool',
  ...
  {
    ...gear(source.voab.key, 75, 'Teleport Homer', '9U', 'Tool,Imperium,Adeptus Astartes'),
    type: 'Tool',
