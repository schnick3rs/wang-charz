...
const source = {
  ...
  aaoa2: { book: 'An Abundance of Apocrypha (v2)', supplements: 'core10', key: 'aaoa2', version: 'v2', path: '/vault/an-abundance-of-apocrypha' },
  lotn: {
...
const core = [
  ...
  {
    name: 'Aspring Champion',
    ...threatz('core', 342, 'Heretical', 'Aspring Champion', 'aeee'),
    ...keywordz('Chaos, Heretic Astartes'),
    ...attributz('8 6 5 4 4 3 2'),
    ...traitz('4 10 12 8 4 4 7 Avg'),
    ...skillz(5, 'Awareness 9 (Passive 5), Ballistic Skill 8, Weapon Skill 8'),
