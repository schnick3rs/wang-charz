...
const paxRep = [
  ...
  simpleStub('pax', '-', 'core-navigator', 'Navis Nobility Houses', 'Navis Scion', 20, 1),
  simpleStub('pax', '-', 'core-navigator', 'Navis Nobility Houses', 'Nobilite Emessary', 10, 1),
  simpleStub('pax', '-', 'core-navigator', 'Navis Nobility Houses', 'Navigator Primaris', 30, 2),
  simpleStub('pax', '-', 'core-navigator', 'Navis Nobility Houses', 'Nogator', 40, 3),
  simpleStub('pax', '-', 'core-navigator', 'Navis Nobility Houses', 'Heir-Apparent', 50, 4),
