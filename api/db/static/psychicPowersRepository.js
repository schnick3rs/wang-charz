...
const aaoaWaaaghPowers = [
  {
    ...
    ...simpleCrunch('7', 'Action', 'Instant', '18m', false, ''),
  ...
  },
  {
    ...
    ...simpleCrunch('6', 'Full Action', 'Instant', '12m', false, ''),
    keywords: ['Ork','Psychic'],
    description:
  ...
  },
  {
    ...
    ...simpleCrunch('5', 'Action', '1 Round', '12m', false, ''),
    keywords: ['Ork','Psychic'],
    description:
  ...
  },
  {
    ...
    ...simpleCrunch('7', 'Full Action', 'Sustained', '18m', false, ''),
  ...
  },
  {
    ...
    ...simpleCrunch('6', 'Action', 'Instant', '18m', false, ''),
    keywords: ['Ork','Psychic'],
    description:
