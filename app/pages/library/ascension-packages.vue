...
const { data, pending } = await useAsyncData(
    'ascension-packages',
    (_nuxtApp, { signal }) => $fetch('/api/ascension-packages', { signal }),
)
...
<template>
  ...
  <h1 class="text-3xl sm:text-4xl text-pretty font-bold text-highlighted border-b-4 pb-2 border-b-orange-600">Species</h1>
