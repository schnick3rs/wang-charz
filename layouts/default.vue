        ...
        <v-row justify="center" no-gutters>
          <v-col :cols="12" :xl="8">
            <v-alert
              ...
              elevation="4"
            >
              <p>Attention citizen... the revised (v1.5?) Wrath & Glory Rulebook is out (as a PDF at least). Im working on bringing the <nuxt-link to="/forge/my-characters">FORGE</nuxt-link> up to date. Also, keep in mind, that some/most of the homebrews in the <nuxt-link to="/vault">VAULT</nuxt-link> are not yet updated.</p>
